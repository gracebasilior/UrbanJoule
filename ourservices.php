...
$titles = $db->query("SELECT header AS `text`, photograph FROM subpage WHERE subpage = 'ourservices' ORDER BY position ASC");
...
.new-book { position:absolute; left:4px; top:114px; width:871px; height:435px; background:url('images/ourservices-background.jpg') top left no-repeat; }
...
<div id="wrapper">
  ...
  <div class="new-book">
  	<img src="images/ourservices-tabs.jpg" width="53" height="435" align="right" usemap="#Map">
    <map name="Map">
    ...
    <div class="left-page">
    	<p>
        <img src="images/services-header.jpg" width="306" height="43">
      </p>
